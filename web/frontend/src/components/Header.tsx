...
import { Upload, Mic, Settings, LogOut, Home, Plus, Grip, Zap, Youtube, Video, Users, MessageSquare } from "lucide-react";
				...
				<div className="flex items-center gap-2 sm:gap-3">
					...
					<DropdownMenu>
						...
						<DropdownMenuContent align="end" className="w-44 bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
							...
							<DropdownMenuItem onClick={() => navigate({ path: "global-chat" })} className="cursor-pointer">
